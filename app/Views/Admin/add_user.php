                    ...
                    <div class="card-body">
                        <div class="tab-form cadastro">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="select-wrap">
                                            <select id="classificacao-user" name="classificacao-user" class="form-control" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input id="nome-user" name="nome-user" type="text" value="" class="form-control vnome" placeholder="Nome do Usuário" required>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="checkbox-custom checkbox-primary">
                                                <input class="require-one" type="checkbox" id="user-agua" name="user-agua">
                                                <label for="user-agua">Água</label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="checkbox-custom checkbox-success">
                                                <input class="require-one" type="checkbox" id="user-gas" name="user-gas">
                                                <label for="user-gas">Gás</label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="checkbox-custom checkbox-warning">
                                                <input class="require-one" type="checkbox" id="user-energia" name="user-energia">
                                                <label for="user-energia">Energia</label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="checkbox-custom checkbox-info">
                                                <input class="require-one" type="checkbox" id="user-nivel" name="user-nivel">
