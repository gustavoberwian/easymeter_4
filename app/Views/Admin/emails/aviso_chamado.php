                                        ...
                                        <table width="380" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#4c4c4c; font-weight:bold; line-height:40px;" mc:edit="bm16-03"><multiline>O chamado #<?= $cid; ?> foi criado.</multiline></td>
                                                        </tr>
                                                        <tr>
                                                            <td height="10" align="center" valign="top" style="line-height:10px;">&nbsp;</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#4c4c4c; font-weight:normal; line-height:24px;" mc:edit="bm16-04">
                                                                <multiline>
                                                                    <a href=<?= "http://easymeter.com.br/admin/suporte/" . $id ?>>Acompanhe aqui</a>
                                                                </multiline>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <table width="380" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                            ...
                                            <tr>
                                                <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#FFF; font-weight:normal; line-height:28px;" mc:edit="bm14-03"><multiline>Easymeter - UNO Robótica Ltda.</multiline></td>
                                            </tr>
                                            <tr>
                                                <td align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#FFF; font-weight:bold; line-height:28px;" mc:edit="bm14-04"><multiline>Copyright &copy; 2017-<?= date('Y'); ?> UNO Robótica</multiline></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
