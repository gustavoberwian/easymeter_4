						...
						<div class="card-body">
							<div class="thumb-info mb-3 text-center">
								...
								<div class="thumb-info-title">
									...
									<span class="thumb-info-type"><?php echo $url; ?></span>
							    </div>
							</div>
                                        ...
                                        <form  id="profile" class="profile p-3" autocomplete="off">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control telefone" name="telefone" id="telefone" placeholder="(00) 0000-0000" value="<?php echo set_value('telefone', $user->telefone); ?>">
                                                    <?php echo $validation->getError('telefone'); ?>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Celular</label>
                                                    <input type="text" class="form-control telefone" name="celular" id="celular" placeholder="(00) 0000-0000" value="<?php echo set_value('celular', $user->celular); ?>">
