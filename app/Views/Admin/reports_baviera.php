                    ...
                    <div class="row pt-0">
                        <div class="col-lg-4">
                            <section class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped table-hover table-clickable" id="dt-agua-gas" data-url="<?php echo site_url('ajax/b_ag'); ?>">
                                        <thead>
                                            <tr role="row">
                        ...
                        <div class="col-lg-4">
                            <section class="card h-100">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped table-hover table-clickable" id="dt-gas-agua" data-url="<?php echo site_url('ajax/b_ga'); ?>">
                                        <thead>
                                            <tr role="row">
                                                <th width="25%">Bloco</th>
                                                <th width="25%">Unidade</th>
                        ...
                        <div class="col-lg-4">
                            <section class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped table-hover table-clickable" id="dt-agua-inf" data-url="<?php echo site_url('ajax/b_ai'); ?>">
                                        <thead>
                                            <tr role="row">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <section class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped table-hover table-clickable" id="dt-agua-z" data-url="<?php echo site_url('ajax/b_az'); ?>">
                                        <thead>
                                            <tr role="row">
                                                <th width="33%">Bloco</th>
                                                <th width="33%">Unidade</th>
                        ...
                        <div class="col-lg-4 vazamento">
                            <section class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped table-hover table-clickable" id="dt-agua-v" data-url="<?php echo site_url('ajax/b_av'); ?>">
                                        <thead>
                                            <tr role="row">
                        ...
                        <div class="col-lg-4">
                            <section class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped table-hover table-clickable" id="dt-gas-v" data-url="<?php echo site_url('ajax/b_gv'); ?>">
                                        <thead>
                                            <tr role="row">
                                                <th width="33%">Bloco</th>
                                                <th width="33%">Unidade</th>
