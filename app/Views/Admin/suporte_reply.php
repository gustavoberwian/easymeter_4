                                ...
                                <div class="mailbox-email-header mb-3">
                                    <h3 class="mailbox-email-subject m-0 font-weight-light">
                                        ...
                                        <?php if ($chamado->status != 'fechado'): ?>
                                            <form method="post">
                                                <button type="submit" class="btn btn-sm btn-success float-right" name="fechar" value ="fechar">Fechar Chamado</button>
                                            </form>
                                        <?php endif; ?>
                                    </h3>
                                    ...
                                    <div class="mailbox-email-screen pt-4">
                                            ...
                                            <?php foreach($replys as $r) { ?>
                                                ...
                                                <div class="card mb-3">
                                                    <div class="card-header">
                                                        <p class="card-title">Resposta de <?= (is_null($r->nome)) ? $chamado->nome : $r->nome; ?></p>
                                                    </div>
                                                    <div class="card-body">
                                                        <p><?= $r->mensagem; ?></p>
                                                    </div>
                                                    <div class="card-footer">
                                                        <p class="m-0"><small><?= date("d/m/Y H:i", strtotime($r->cadastro)); ?></small></p>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        <?php endif; ?>
                                        <?php if ($chamado->status == 'fechado'): ?>
                                            <div class="alert alert-success">
                                                Chamado Fechado em <?= date("d/m/Y \à\s H:i", strtotime($chamado->fechado_em)); ?> por <?= $chamado->user_name; ?>
        									</div>                                        
                                        <?php endif; ?>
                                    ...
                                    <form method="post">
                                        <div class="compose pt-3">
                                            <div id="compose-field" class="compose">
                                                <textarea name="message" rows="5" style="width:100%; border-radius:5px;" required></textarea>
                                            </div>
                                            <div class="text-right">
                                                <button type="submit" class="btn btn-primary" name="reply" value ="reply">Responder</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                <script>
                    var error = <?= ($chamado_close && $chamado_reply) ? 'false' : 'true'; ?>;
                </script>