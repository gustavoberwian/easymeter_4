<section role="main" class="content-body">
    ...
    <?php if (empty($user->config)): ?>
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Atenção!</strong> Configurações gerais do shopping não fornecidas. <a
                href="/shopping/<?= $url ?>/<?= $group_id ?>" class="alert-link">Clique aqui</a> e configure-os para
    ...
    <div class="row">
        <div class="col-9">
            <div class="nav-wrap-desk">
                <ul class="nav nav-pills nav-pills-primary mb-3">
                    ...
                    <?php endif; ?>
                    <li class="nav-item configs" role="presentation">
                        <button class="nav-link configs <?= $user->inGroup("unity") ? 'left active' : '' ?>"
                            data-bs-toggle="pill" data-bs-target="#charts" type="button">Medição</button>
                    </li>
                    <?php if (!$user->inGroup("unity") || $permission->acessar_engenharia): ?>
                        <li class="nav-item configs" role="presentation">
                            <button class="nav-link configs" data-bs-toggle="pill" data-bs-target="#engineering"
                                type="button">Engenharia</button>
                        </li>
                    <?php endif; ?>
                    <li class="nav-item configs" role="presentation">
                        <button class="nav-link configs" data-bs-toggle="pill" data-bs-target="#analysis"
                            type="button">Análises</button>
                    </li>
                    <li class="nav-item configs" role="presentation">
                        <button class="nav-link configs" data-bs-toggle="pill" data-bs-target="#data"
                            type="button">Dados</button>
                    </li>
                </ul>
            </div>
        ...
        <?php if($user->entity->image_url): ?>
            <div class="col-3 text-end">
                <img src="<?php echo base_url('assets/img/' . $user->entity->image_url); ?>" alt="<?= ""; ?>" class="mb-3 pr-1"
                    height="50" />
            </div>
        <?php endif; ?>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="h5 mb-0 mt-1">
                                <?= ($user->demo) ? "<span>" . number_format(mt_rand(10000, 100000), 0, ',', '.') . "</span> <span style='font-size:12px;'>kWh</span>" : "<span class='main'>-</span>" ?>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div class="col-md-2 mb-4">
                    <section class="card card-comparativo h-100 h-100">
                        <div class="card-body" style="background-color: #03aeef;">
                            <h6 class="card-body-title mb-3 mt-0 text-light">Medidor <i
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4 pr-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? '<span>' . number_format(mt_rand(1000, 10000), 0, ',', '.') . "</span> <span style='font-size:12px;'>kWh</span>" : "<span class='day'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">Consumo</p>
                            </div>
                            <div class="col-lg-4 pr-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? '<span style="color: #268ec3;">' . number_format(mt_rand(1000, 10000), 0, ',', '.') . "</span> <span style='font-size:12px;'>kWh</span>" : "<span class='day-f'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">Fora Ponta</p>
                            </div>
                            <div class="col-lg-4 pr-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? '<span style="color: #ff6178;">' . number_format(mt_rand(1000, 10000), 0, ',', '.') . "</span> <span style='font-size:12px;'>kWh</span>" : "<span class='day-p'>-</span>" ?>
                                </div>
                ...
                <section class="card card-comparativo h-100">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4 pr-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? number_format(mt_rand(1000, 10000), 0, ',', '.') . " <span style='font-size:12px;'>kWh</span>" : "<span class='period'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">Período selecionado</p>
                            </div>
                            <div class="col-lg-4 pl-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? number_format(mt_rand(1000, 10000), 0, ',', '.') . " <span style='font-size:12px;'>kWh</span>" : "<span class='month'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">No mês atual</p>
                            </div>
                            <div class="col-lg-4 pl-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? number_format(mt_rand(1000, 10000), 0, ',', '.') . " <span style='font-size:12px;'>kWh</span>" : "<span class='prevision'>-</span>" ?>
                                </div>
                ...
                <section class="card card-comparativo h-100">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4 pr-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? number_format(mt_rand(1000, 10000), 0, ',', '.') . " <span style='font-size:12px;'>kWh</span>" : "<span class='period-f'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">Período selecionado</p>
                            </div>
                            <div class="col-lg-4 pl-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? number_format(mt_rand(1000, 10000), 0, ',', '.') . " <span style='font-size:12px;'>kWh</span>" : "<span class='month-f'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">No mês atual</p>
                            </div>
                            <div class="col-lg-4 pl-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? number_format(mt_rand(1000, 10000), 0, ',', '.') . " <span style='font-size:12px;'>kWh</span>" : "<span class='prevision-f'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">Previsão no mês</p>
                            </div>
                        </div>
                ...
                <section class="card card-comparativo h-100">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4 pr-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? number_format(mt_rand(1000, 10000), 0, ',', '.') . " <span style='font-size:12px;'>kWh</span>" : "<span class='period-p'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">Período selecionado</p>
                            </div>
                            <div class="col-lg-4 pl-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? number_format(mt_rand(1000, 10000), 0, ',', '.') . " <span style='font-size:12px;'>kWh</span>" : "<span class='month-p'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">No mês atual</p>
                            </div>
                            <div class="col-lg-4 pl-1">
                                <div class="h5 mb-0 mt-1">
                                    <?= ($user->demo) ? number_format(mt_rand(1000, 10000), 0, ',', '.') . " <span style='font-size:12px;'>kWh</span>" : "<span class='prevision-p'>-</span>" ?>
                                </div>
                                <p class="text-3 text-muted mb-0">Previsão no mês</p>
                            </div>
                        </div>
                ...
                <section class="card card-easymeter mb-4">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-hover table-click" id="dt-resume"
                            data-url="<?= ($user->demo) ? "/energia/resume_demo" : "/energia/resume" ?>"
            ...
            <div class="row pt-0">
                ...
                <div class="col-md-8 mb-4">
                    <section class="card card-easymeter h-100 mb-4">
                        <header class="card-header">
                            <div class="card-actions buttons">
                                <button type="button" class="btn btn-lg btn-primary" data-bs-trigger="focus"
                                    data-bs-toggle="popover" title="Consumo Energia Ativa"
                                    data-bs-content="Energia real consumida pela carga (iluminação, ar-condicionado e equipamentos em geral) sendo o principal fator utilizado para conversões monetárias."><i
                                        class="float-end fas fa-info-circle"></i></button>
                            </div>
                ...
                <div class="col-md-4 mb-4">
                    <section class="card card-easymeter h-100 mb-4">
                        <header class="card-header">
                            <div class="card-actions buttons">
                                <button type="button" class="btn btn-lg btn-primary" data-bs-trigger="focus"
                                    data-bs-toggle="popover" title="Consumo Por Posto"
                                    data-bs-content="Postos tarifários são períodos do dia em que as tarifas de energia são diferentes. São divididos em: PONTA (horário de maior consumo da região), FORA PONTA e, em alguns casos, INTERMEDIÁRIO."><i
                                        class="float-end fas fa-info-circle"></i></button>
                            </div>
                            <h2 class="card-title">Consumo por Posto</h2>
                        </header>
                        <div class="card-body chart_station-body d-flex align-items-center" data-loading-overlay
                            data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                            <div class="chart-container">
                ...
                <div class="col-md-12 mb-4">
                    <section class="card card-easymeter h-100 mb-4">
                        <header class="card-header">
                            <div class="card-actions buttons">
                                <button type="button" class="btn btn-lg btn-primary" data-bs-trigger="focus"
                                    data-bs-toggle="popover" title="Energia Reativa"
                                    data-bs-content="Refere-se àquela parte da energia que não realiza diretamente trabalho. Tem origem, por exemplo, na formação de campos magnéticos de alguns equipamentos como motores, transformadores e bobinas. As concessionárias cobram multas pelo excesso deste consumo."><i
                                        class="float-end fas fa-info-circle"></i></button>
                            </div>
                            <h2 class="card-title">Energia Reativa</h2>
                        </header>
                        <div class="card-body chart_reactiv-body" data-loading-overlay
                            data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                            <div class="chart-container">
                ...
                <div class="col-md-12 mb-4">
                    <section class="card card-easymeter h-100 mb-4">
                        <header class="card-header">
                            <div class="card-actions buttons">
                                <button type="button" class="btn btn-lg btn-primary" data-bs-trigger="focus"
                                    data-bs-toggle="popover" title="Fator de Potência"
                                    data-bs-content="Resultado da relação entre o consumo da energia ativa e da reativa. É o fator de potência que determina a aplicação de multas quando os valores fogem dos limites estipulados (por padrão deve ficar entre 0,92 e 1). Quanto mais próximo de 1, melhor."><i
                                        class="float-end fas fa-info-circle"></i></button>
                            </div>
                            <h2 class="card-title">Fator de Potência</h2>
                        </header>
                        <div class="card-body chart_factor1-body" data-loading-overlay
                            data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                            <div class="chart-container">
                ...
                <div class="col-md-12 mb-4">
                    <section class="card card-easymeter h-100 mb-4">
                        <header class="card-header">
                            <div class="card-actions buttons">
                                <button type="button" class="btn btn-lg btn-primary" data-bs-trigger="focus"
                                    data-bs-toggle="popover" title="Fator de Carga"
                                    data-bs-content="Determina a eficiência energética da instalação. Pode ser calculado de duas formas, mas aqui é o resultado da razão entre a potência média e máxima consumidas no intervalo de tempo estipulado. Quanto mais próximo de 1, melhor."><i
                                        class="float-end fas fa-info-circle"></i></button>
                            </div>
                            <h2 class="card-title">Fator de Carga</h2>
                        </header>
                        <div class="card-body chart_profile-body" data-loading-overlay
                            data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                            <div class="chart-container">
                ...
                <div class="col-md-12 mb-4">
                    <section class="card card-easymeter h-100 mb-4">
                        <header class="card-header">
                            <div class="card-actions buttons">
                                <button type="button" class="btn btn-lg btn-primary" data-bs-trigger="focus"
                                    data-bs-toggle="popover" title="Emissão de GEE"
                                    data-bs-content="Representação do volume total de gases de efeito estufa (GEE) gerado pelo consumo de energia ativa."><i
                                        class="float-end fas fa-info-circle"></i></button>
                            </div>
                            <h2 class="card-title">Pegada de Carbono </h2>
                        </header>
                        <div class="card-body chart_carbon1-body" data-loading-overlay
                            data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                            <div class="chart-container">
                ...
                <header class="card-header">
                    <div class="card-actions buttons">
                        <?php if ($permission->baixar_planilhas): ?>
                            <button type="button" class="btn btn-primary btn-download-abnormal me-2"
                                data-group="<?= $group_id; ?>" data-loading-overlay disabled><i
                                    class="fas fa-file-download mr-3"></i> Baixar Planilha</button>
                        <?php endif; ?>
                        <button type="button" class="btn btn-lg btn-primary" data-bs-trigger="focus"
                            data-bs-toggle="popover" title="Lista de Anomalias"
                            data-bs-content="Aqui é possível identificar anomalias ocorridas no sistema a partir de parâmetros estipulados pelo usuário"><i
                                class="float-end fas fa-info-circle"></i></button>
                    </div>
                    <h2 class="card-title">Análise de Anomalias</h2>
                </header>
                <div class="card-body chart_abnormal-body" data-loading-overlay
                    data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                    ...
                    <form class="row gx-3 gy-2 align-items-center">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-4">
                                    <input type="text" placeholder="Mínimo" class="form-control mb-2" name="min"
                                        id="min" value="">
                                </div>
                                <div class="col-lg-4">
                                    <input type="text" placeholder="Máximo" class="form-control mb-2" name="max"
                                        id="max" value="">
                                </div>
                                <div class="col-lg-4">
                    ...
                    <table class="table table-bordered table-striped table-hover" id="dt-abnormal"
                        data-buttons="<?= $permission->baixar_planilhas ? 'true' : 'false' ?>">
                        <thead>
                            <tr role="row">
        ...
        <?php if (!$user->inGroup("unity") || $permission->acessar_engenharia): ?>
            <div class="tab-pane fade" id="engineering">
                ...
                <section class="card card-easymeter mb-4">
                    ...
                    <div class="card-body chart_active-body" data-loading-overlay
                        data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                        <div class="chart-container">
                ...
                <div class="row pt-0">
                    <div class="col-md-6 mb-4">
                        <section class="card card-easymeter h-100 mb-4">
                            ...
                            <div class="card-body chart_current-body" data-loading-overlay
                                data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                                <div class="chart-container">
                    ...
                    <div class="col-md-6 mb-4">
                        <section class="card card-easymeter h-100 mb-4">
                            ...
                            <div class="card-body chart_voltage-body" data-loading-overlay
                                data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                                <div class="chart-container">
                ...
                <div class="row pt-0">
                    <div class="col-md-12 mb-4">
                        <section class="card card-easymeter h-100 mb-4">
                            ...
                            <div class="card-body chart_activedemand-body" data-loading-overlay
                                data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                                <div class="chart-container">
                ...
                <div class="row pt-0">
                    <div class="col-md-12 mb-4">
                        <section class="card card-easymeter h-100 mb-4">
                            ...
                            <div class="card-body chart-factor-body" data-loading-overlay
                                data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                                <div class="chart-container">
                ...
                <div class="row pt-0">
                    <div class="col-md-12 mb-4">
                        <section class="card card-easymeter h-100 mb-4">
                            ...
                            <div class="card-body chart-reactive-body" data-loading-overlay
                                data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
                                <div class="chart-container">
        ...
        <div class="tab-pane fade" id="data">
                ...
                <div class="col-md-12 mb-4">
                    <section class="card card-easymeter h-100 mb-4">
                        <header class="card-header">
                            <div class="card-actions buttons">
                                <button type="button" class="btn btn-lg btn-primary" data-bs-trigger="focus"
                                    data-bs-toggle="popover" title="Consumo Últimas 24h"
                                    data-bs-content="Consumo de energia ativa consumida a cada 10 min nas últimas 24h."><i
                                        class="float-end fas fa-info-circle"></i></button>
                            </div>
                            <h2 class="card-title">Consumo Últimas 24h</h2>
                        </header>
                        <div class="card-body chart_consumption-body" data-loading-overlay
                            data-loading-overlay-options='{ "css": { "backgroundColor": "#00000080" } }'>
            ...
            <section class="card card-easymeter mb-4">
                <header class="card-header">
                    <div class="card-actions buttons">
                        <button type="button" class="btn btn-lg btn-primary" data-bs-trigger="focus"
                            data-bs-toggle="popover" title="Dados"
                            data-bs-content="Lista dos dados enviados pelos equipamentos de medição Easymeter instalados."><i
                                class="float-end fas fa-info-circle"></i></button>
                    </div>
