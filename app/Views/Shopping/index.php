                                ...
                                <div class="item profile-info p-0 overflow-hidden">
                                    ...
                                    <div class="row m-0 fixed-card-bottom">
                                        <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="h5 m0 color-f1"><span class="main"><?= ($user->inGroup('demo')) ? number_format(mt_rand(10000, 100000), 0, ',', '.') : $overall_c[$i]["consum"]; ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <h6 class="card-body-title mb-0 text-primary"></br>Previsão</h6>
                                            <div class="row">
                                                <div class="h5 m0 color-f1"><span class="main"><?= ($user->demo) ? number_format(mt_rand(10000, 100000), 0, ',', '.') : $overall_c[$i]["prevision"] ?></div>
                                            </div>
                                        </div>
