<main>
    ...
    <section id="destaques">
        ...
        <div class="d-flex">
            <img src="<?= base_url('/assets/img/site/easymeter_destaques_simbolo.svg'); ?>" width="50%" alt="">
            ...
            <div class="individualizacao-box">
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-7 right-side">
                        ...
                        <div class="bloco d-flex">
                            <?php include_once 'assets/svgs/icon_coin.php'; ?>
                            <div class="text-structure">
            ...
            <div class="clients-logos">
                <div class="row text-center ">
                    <div class="little-logo col-4 ">
                        <img src="<?= base_url('/assets/img/site/easymeter_clientes_logo01.jpg'); ?>" class="logo-little" alt="Ambev">
                    </div>
                    <div class="little-logo col-4 ">
                        <img src="<?= base_url('/assets/img/site/easymeter_clientes_logo02.jpg'); ?>" class="logo-little" alt="Botanique">
                    </div>
                    <div class="little-logo col-4 ">
                        <img src="<?= base_url('/assets/img/site/easymeter_clientes_logo03.jpg'); ?>" class="logo-little" alt="Serasa Experian">
                    </div>
                </div>
                <div class="row text-center ">
                    <div class="little-logo col-4 ">
                        <img src="<?= base_url('/assets/img/site/easymeter_clientes_logo04.jpg'); ?>" class="logo-little" alt="Hortolândia">
                    </div>
                    <div class="little-logo col-4 ">
                        <img src="<?= base_url('/assets/img/site/easymeter_clientes_logo05.jpg'); ?>" class="logo-little" alt="Hyundai">
                    </div>
                    <div class="little-logo col-4 ">
                        <img src="<?= base_url('/assets/img/site/easymeter_clientes_logo06.jpg'); ?>" class="logo-little" alt="Randon">
                    </div>
                </div>
            </div>
        </div>
